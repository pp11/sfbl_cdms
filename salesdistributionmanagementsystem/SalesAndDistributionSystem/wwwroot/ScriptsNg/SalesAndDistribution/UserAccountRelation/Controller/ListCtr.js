ngApp.controller('ngGridCtrl', ['$scope', 'InsertOrEditServices', 'CustomerInfoServices', 'permissionProvider', 'notificationservice', 'gridregistrationservice', '$http', '$log', '$filter', '$timeout', '$interval', '$q', function ($scope, InsertOrEditServices, CustomerInfoServices, permissionProvider, notificationservice, gridregistrationservice, $http, $log, $filter, $timeout, $interval, $q) {
    ...
    'use strict'
    $scope.model = { COMPANY_ID: 0, USER_ID: 0, USER_CODE: '', USER_TYPE: 'Active', EFFECT_START_DATE: '', EFFECT_END_DATE: '', REMARKS: '' }
    ...
    $scope.gridOptionsList.columnDefs = [
        ...
        , { name: 'USER_ACCOUNT_MST_ID', field: 'USER_ID', visible: false }
        
        , { name: 'USER_ID', field: 'USER_ID', visible: false }
        , { name: 'COMPANY_ID', field: 'COMPANY_ID', visible: false }

        , {
            name: 'USER_NAME', field: 'USER_NAME', displayName: 'Name', enableFiltering: true, width: '20%'
        }
        , {
            name: 'USER_CODE', field: 'USER_CODE', displayName: 'Code', enableFiltering: true, width: '12%'
        }
        , {
        ...
        , { name: 'USER_TYPE', field: 'USER_TYPE', displayName: 'Status', enableFiltering: true, width: '15%' }
        , {
    ...
    $scope.EditData = function (entity) {
        ...
        window.location = "/SalesAndDistribution/UserAccountRelation/InsertOrEdit?Id=" + entity.USER_ACCOUNT_MST_ID_ENCRYPTED;
    ...
    $scope.ClearForm = function () {
        window.location = "/SalesAndDistribution/UserAccountRelation/List";
    }
