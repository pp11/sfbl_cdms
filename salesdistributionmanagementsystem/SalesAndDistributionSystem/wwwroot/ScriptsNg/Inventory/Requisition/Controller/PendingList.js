ngApp.controller('ngGridCtrl', ['$scope', 'RequisitionServices', 'AreaInfoServices', 'permissionProvider', 'notificationservice', 'gridregistrationservice', '$http', '$log', '$filter', '$timeout', '$interval', '$q', function ($scope, requisitionServices, AreaInfoServices, permissionProvider, notificationservice, gridregistrationservice, $http, $log, $filter, $timeout, $interval, $q) {
    ...
    $scope.gridRequisitionList.columnDefs = [
        ...
        , {
            name: 'ISSUE_UNIT_NAME', field: 'ISSUE_UNIT_NAME', displayName: 'Issue Unit', enableFiltering: true, width: '10%'
        }
        , {
            name: 'REQUISITION_AMOUNT', field: 'REQUISITION_AMOUNT', displayName: 'Requisition Amount', enableFiltering: true, width: '20%'
        }
        , {
            name: 'TOTAL_WEIGHT', field: 'TOTAL_VOLUME', displayName: 'tOTAL VOLUME', enableFiltering: true, width: '20%'
        }
        , {
            name: 'TOTAL_WEIGHT', field: 'TOTAL_WEIGHT', displayName: 'TOTAL WEIGHT', enableFiltering: true, width: '20%'
        }
        , {
