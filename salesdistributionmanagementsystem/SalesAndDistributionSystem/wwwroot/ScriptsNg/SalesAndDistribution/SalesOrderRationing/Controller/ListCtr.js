ngApp.controller('ngGridCtrl', ['$scope', 'InsertOrEditServices', 'permissionProvider', 'notificationservice', 'gridregistrationservice', '$http', '$log', '$filter', '$timeout', '$interval', '$q', function ($scope, InsertOrEditServices, permissionProvider, notificationservice, gridregistrationservice, $http, $log, $filter, $timeout, $interval, $q) {
    ...
    $scope.gridOptionsList.columnDefs = [
        ...
        , {
            name: 'CUSTOMER_NAME', field: 'CUSTOMER_NAME', displayName: 'Customer', enableFiltering: true, width: '18%'
        }
        , {
            name: 'ORDER_DATE', field: 'ORDER_DATE', displayName: 'OrderDate', enableFiltering: true, width: '15%'
        }
        , {
            name: 'DELIVERY_DATE', field: 'DELIVERY_DATE', displayName: 'Delivery Date', enableFiltering: true, width: '15%'
        }
        , {
            name: 'MARKET_NAME', field: 'MARKET_NAME', displayName: 'Market', enableFiltering: true, width: '18%'
        }
        , {
            name: 'ORDER_AMOUNT', field: 'ORDER_AMOUNT', displayName: 'Order Amount', enableFiltering: true, width: '12%'
        }
