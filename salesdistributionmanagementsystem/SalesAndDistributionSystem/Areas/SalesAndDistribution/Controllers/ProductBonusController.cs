...
namespace SalesAndDistributionSystem.Areas.SalesAndDistribution.Controllers
{
    ...
    {
        private readonly IProductBonusManager _service;
        private readonly ILogger<ProductBonusController> _logger;
        private readonly IConfiguration _configuration;
        private readonly ICommonServices _common;

        private readonly ServiceProvider Provider = new ServiceProvider();

        public ProductBonusController(IProductBonusManager service, ILogger<ProductBonusController> logger, IConfiguration configuration, ICommonServices common)
        {
            _service = service;
            _logger = logger;
        ...
        public IActionResult BonusConfig(string Id = "0")
         {
            Product_Bonus_Mst bonus_Mst = new Product_Bonus_Mst();

            if (Id != "0" || Id != "")
            {
                bonus_Mst.PRODUCT_BONUS_MST_ID_ENCRYPTED = Id;
            }
        ...
        [HttpPost]
        public async Task<string> LoadData([FromBody] Product_Bonus_Mst bonus_Mst)
        {
        ...
        [HttpPost]
        public async Task<string> LoadBaseProductData([FromBody] Product_Bonus_Mst bonus_Mst)
        {
        ...
        [HttpPost]
        public async Task<string> LoadProductData([FromBody] Product_Bonus_Mst bonus_Mst)
        {
        ...
        [HttpPost]
        public async Task<string> LoadGroupData([FromBody] Product_Bonus_Mst bonus_Mst)
        {
        ...
        [HttpPost]
        public async Task<string> LoadBrandData([FromBody] Product_Bonus_Mst bonus_Mst)
        {
        ...
        [HttpPost]
        public async Task<string> LoadCategoryData([FromBody] Product_Bonus_Mst bonus_Mst)
        {
        ...
        [HttpPost]
        public int LoadNewBonusNo([FromBody] Product_Bonus_Mst bonus_Mst) => _service.LoadNewBonusNo(GetDbConnectionString());
       
        [HttpPost]
        public string LoadLocationTypes([FromBody] Product_Bonus_Mst bonus_Mst)
        {
        ...
        [HttpPost]
        public async Task<string> LoadLocation_ByLocationType([FromBody] Product_Bonus_Mst bonus_Mst)
        {
            int comp_id = bonus_Mst == null || bonus_Mst.COMPANY_ID == 0 ? Convert.ToInt32(User.Claims.FirstOrDefault(x => x.Type == ClaimsType.CompanyId).Value) : bonus_Mst.COMPANY_ID;
        ...
        [HttpPost]
        public async Task<string> GetEditDataById([FromBody] Product_Bonus_Mst mst)
        {
            Product_Bonus_Mst bonus_Mst = new Product_Bonus_Mst();
        ...
        [HttpPost]
        public async Task<JsonResult> AddOrUpdate([FromBody] Product_Bonus_Mst model)
        {
