...
{
    public interface IDepotCustomerManager
    {

        Task<string> AddOrUpdate(string db, Depot_Customer_Mst model);
        ...
        Task<Depot_Customer_Mst> LoadDetailData_ByMasterId_List(string db, int Id);
    }
}
