ngApp.service("AdjustmentServices", function ($http) {
    ...
    this.LoadData = function (companyId) {
        return $http.post('/SalesAndDistribution/OrderAdjustment/LoadData', { COMPANY_ID: parseInt(companyId) });
    }
    ...
    this.GetAdjustmentList = function (companyId) {
    ...
    this.AddOrUpdate = function (model) {
        ...
        return $http({
            type: 'POST',
            method: 'POST',
            url: "/SalesAndDistribution/OrderAdjustment/AddOrUpdate",
            dataType: 'json',
