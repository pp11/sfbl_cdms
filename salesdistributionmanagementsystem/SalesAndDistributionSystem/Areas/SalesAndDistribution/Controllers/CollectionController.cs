...
namespace SalesAndDistributionSystem.Areas.SalesAndDistribution.Controllers
{
    ...
    public class CollectionController : Controller
    {
        ...
        public CollectionController(ICommonServices comservice, ICollectionManager service, ILogger<CollectionController> logger, IConfiguration configuration)
        {
        ...
        [HttpPost]
        public async Task<string> LoadCustomerDaywiseBalance([FromBody] Collection_Dtl collection_Dtl) => await _service.LoadCustomerDaywiseBalance(GetDbConnectionString(), collection_Dtl.CUSTOMER_ID.ToString(),GetUnit());
