ngApp.service("RequisitionReturnService", function ($http) {
    ...
    this.AddOrUpdate = function (model) {
        ...
        return $http({
            type: 'POST',
            method: 'POST',
            url: "/Inventory/RequisitionReturn/AddOrUpdate",
            dataType: 'json',
    ...
    this.LoadRequisitionData = function (companyId) {
        return $http.post('/Inventory/RequisitionReturn/UnreturnedRequisition', { COMPANY_ID: parseInt(companyId) });
    }
    ...
    this.LoadData = function (companyId) {
        return $http.post('/Inventory/RequisitionReturn/LoadData', { COMPANY_ID: parseInt(companyId) });
    }
    this.GetEditDataById = function (id) {
        return $http.post('/Inventory/RequisitionReturn/GetEditDataById', { q: id });
    }
    ...
    this.GetRcvDtlDataById = function (id) {
        return $http.post('/Inventory/RequisitionReceive/GetRcvDtlDataById', { q: id });
    }
});