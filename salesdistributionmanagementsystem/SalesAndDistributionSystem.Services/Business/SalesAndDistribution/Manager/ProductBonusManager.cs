...
{
    public class ProductBonusManager : IProductBonusManager
    {
        private readonly ICommonServices _commonServices;
        private readonly IConfiguration _configuration;
        public ProductBonusManager(ICommonServices commonServices, IConfiguration configuration)
        {
        ...
        string LoadData_Query() => @"Select
                                ROW_NUMBER() OVER(ORDER BY PRODUCT_BONUS_MST_ID ASC) AS ROW_NO
                               ...
                               ,STATUS
                               ,UNIT_ID
                               from PRODUCT_BONUS_MST 

                                Where COMPANY_ID = :param1";

        
  string LoadBonusMstById_Query() => @"Select
                                ROW_NUMBER() OVER(ORDER BY M.PRODUCT_BONUS_MST_ID ASC) AS ROW_NO
                               ,M.PRODUCT_BONUS_MST_ID
                               ,M.BONUS_NAME
                               ,M.COMPANY_ID
                               ,M.EFFECT_END_DATE
                               ,M.EFFECT_START_DATE
                               ...
                               from PRODUCT_BONUS_MST M, PRODUCT_INFO P

                                Where P.SKU_ID = M.SKU_ID AND M.PRODUCT_BONUS_MST_ID = :param1";
        
        string LoadBonusLocationById_Query() => @"Select
                                ROW_NUMBER() OVER(ORDER BY PRODUCT_BONUS_LOCATION_ID ASC) AS ROW_NO
                                ,PRODUCT_BONUS_LOCATION_ID
                                ,PRODUCT_BONUS_MST_ID
                                ,ENTERED_BY
                                ,ENTERED_DATE
                                ,ENTERED_TERMINAL
                               ...
                               from PRODUCT_BONUS_LOCATION 
                               

                                Where PRODUCT_BONUS_MST_ID = :param1";
        string LoadBonusDtlById_Query() => @"Select
                                ROW_NUMBER() OVER(ORDER BY PRODUCT_BONUS_DTL_ID ASC) AS ROW_NO
                                ,PRODUCT_BONUS_DTL_ID
                                ,PRODUCT_BONUS_MST_ID
                                ,PRODUCT_BONUS_QTY
                                ,PRODUCT_BONUS_SKU_CODE
                                ,PRODUCT_BONUS_SKU_ID
        ...
        string GetNewBonus_Mst_IdQuery() => "SELECT NVL(MAX(PRODUCT_BONUS_MST_ID),0) + 1 PRODUCT_BONUS_MST_ID  FROM PRODUCT_BONUS_MST";
        string GetNewBonus_location_IdQuery() => "SELECT NVL(MAX(PRODUCT_BONUS_LOCATION_ID),0) + 1 PRODUCT_BONUS_MST_ID  FROM PRODUCT_BONUS_LOCATION";
        string GetNewBonus_declare_product_IdQuery() => "SELECT NVL(MAX(PRODUCT_BONUS_DECLARE_ID),0) + 1 PRODUCT_BONUS_MST_ID  FROM PRODUCT_BONUS_DECLARE_PRODUCT";
        string GetNewBonus_Dtl_IdQuery() => "SELECT NVL(MAX(PRODUCT_BONUS_DTL_ID),0) + 1 PRODUCT_BONUS_MST_ID  FROM PRODUCT_BONUS_DTL";

        string GetLocation_ByLocationTypeQuery() => "begin   :param1 := FN_FIND_BONUS_LOCATION(:param2,:param3) ;end;";


        string AddOrUpdate_AddBonus_MstQuery() => @"INSERT INTO PRODUCT_BONUS_MST 
                                         (PRODUCT_BONUS_MST_ID
                                         ,BONUS_NAME
                                         ,COMPANY_ID
                                         ,EFFECT_END_DATE
                                         ...
                                         VALUES ( :param1, :param2, :param3, TO_DATE(:param4, 'DD/MM/YYYY HH:MI:SS AM') ,TO_DATE(:param5, 'DD/MM/YYYY HH:MI:SS AM'),:param6 ,TO_DATE(:param7, 'DD/MM/YYYY HH:MI:SS AM'), :param8,TO_DATE(:param9, 'DD/MM/YYYY HH:MI:SS AM'),:param10 ,:param11,:param12,:param13,:param14,:param15)";
        string AddOrUpdate_UpdateBonusMst_Query() => @"UPDATE PRODUCT_BONUS_MST SET 
                                          BONUS_NAME = :param2
                                         ...
                                         ,UPDATED_BY = :param8, UPDATED_DATE = TO_DATE(:param9, 'DD/MM/YYYY HH:MI:SS AM'), 
                                          UPDATED_TERMINAL = :param10, SKU_ID = :param11, SKU_CODE = :param12 WHERE PRODUCT_BONUS_MST_ID = :param1";
        string AddOrUpdate_AddBonus_LocationQuery() => @"INSERT INTO PRODUCT_BONUS_LOCATION 
                                         (PRODUCT_BONUS_LOCATION_ID
                                          ,PRODUCT_BONUS_MST_ID
                                          ,ENTERED_BY
                                          ,ENTERED_DATE
        ...
        string AddOrUpdate_Delete_LocationQuery() => @"DELETE FROM PRODUCT_BONUS_LOCATION Where PRODUCT_BONUS_LOCATION_ID = :param1";
        string AddOrUpdate_Delete_DeclareProductQuery() => @"DELETE FROM PRODUCT_BONUS_DECLARE_PRODUCT Where PRODUCT_BONUS_DECLARE_ID = :param1";
        string AddOrUpdate_AddBonus_DltQuery() => @"INSERT INTO PRODUCT_BONUS_DTL 
                                         (PRODUCT_BONUS_DTL_ID
                                          ,PRODUCT_BONUS_MST_ID
                                          ,PRODUCT_BONUS_QTY
                                          ,PRODUCT_BONUS_SKU_CODE
        ...
        string AddOrUpdate_BonusDtl_Update_Query() => @"UPDATE PRODUCT_BONUS_DTL SET 
                                           
                                           PRODUCT_BONUS_QTY = :param2
                                          ,PRODUCT_BONUS_SKU_CODE = :param3
                                          ,PRODUCT_BONUS_SKU_ID = :param4
                                          ,PRODUCT_BONUS_SLAB_TYPE = :param5
                                          ,PRODUCT_BONUS_TYPE = :param6
                                         ...
                                         ,UPDATED_BY = :param14, UPDATED_DATE = TO_DATE(:param15, 'DD/MM/YYYY HH:MI:SS AM'), 
                                          UPDATED_TERMINAL = :param16 WHERE PRODUCT_BONUS_DTL_ID = :param1";
        string AddOrUpdate_Bonus_Declare_ProductQuery() => @"INSERT INTO PRODUCT_BONUS_DECLARE_PRODUCT 
                                         (BASE_PRODUCT_ID
                                          ,PRODUCT_BONUS_DECLARE_ID
                                          ,PRODUCT_BONUS_MST_ID
                                          ,BRAND_ID
                                          ,CATEGORY_ID
                                          ,ENTERED_BY
        ...
        public async Task<string> LoadData(string db, int Company_Id)
        {
           DataTable dataTable =   await _commonServices.GetDataTableAsyn(_configuration.GetConnectionString(db), LoadData_Query(), _commonServices.AddParameter(new string[] { Company_Id.ToString() }));
            List<Product_Bonus_Mst> bonus_Msts = new List<Product_Bonus_Mst>();
            if (dataTable.Rows.Count > 0)
            {
                for(int i=0;i<dataTable.Rows.Count;i++)
                {
                    Product_Bonus_Mst _bonus_Mst = new Product_Bonus_Mst();
                    ...
                    _bonus_Mst.PRODUCT_BONUS_MST_ID = Convert.ToInt32(dataTable.Rows[i]["PRODUCT_BONUS_MST_ID"]);
                    ...
                    _bonus_Mst.EFFECT_START_DATE = Convert.ToDateTime(dataTable.Rows[i]["EFFECT_START_DATE"]).ToString("dd/MM/yyyy");
                    _bonus_Mst.EFFECT_END_DATE = Convert.ToDateTime(dataTable.Rows[i]["EFFECT_END_DATE"]).ToString("dd/MM/yyyy");
                    _bonus_Mst.ENTRY_DATE = Convert.ToDateTime(dataTable.Rows[i]["ENTRY_DATE"]).ToString("dd/MM/yyyy");
                    _bonus_Mst.REMARKS = dataTable.Rows[i]["REMARKS"].ToString();
                    _bonus_Mst.PRODUCT_BONUS_MST_ID_ENCRYPTED = _commonServices.Encrypt(_bonus_Mst.PRODUCT_BONUS_MST_ID.ToString());
        ...
        public async Task<Product_Bonus_Mst> LoadEditDataByMasterId(string db, int Id)
        {
            Product_Bonus_Mst _bonus_Mst = new Product_Bonus_Mst();
            ...
            if (dataTable.Rows.Count > 0)
            {
                ...
                _bonus_Mst.PRODUCT_BONUS_MST_ID = Id;
                _bonus_Mst.BONUS_NAME = dataTable.Rows[0]["BONUS_NAME"].ToString();
                _bonus_Mst.SKU_ID = Convert.ToInt32(dataTable.Rows[0]["SKU_ID"].ToString());
                _bonus_Mst.SKU_CODE = dataTable.Rows[0]["SKU_CODE"].ToString();
                _bonus_Mst.SKU_NAME = dataTable.Rows[0]["SKU_NAME"].ToString();
                ...
                _bonus_Mst.Bonus_Locations = new List<Product_Bonus_Location>();
                List<Product_Bonus_Location> _locations = new List<Product_Bonus_Location>();
               ...
               for(int i = 0; i < locations.Rows.Count; i++)
                {
                    Product_Bonus_Location bonus_Location = new Product_Bonus_Location();
                ...
                {
                    Product_Bonus_Location _bonus_Location = new Product_Bonus_Location();
                    
                    _bonus_Location.PRODUCT_BONUS_LOCATION_ID = Convert.ToInt32(dataTable_location.Rows[i]["PRODUCT_BONUS_LOCATION_ID"]);
                    _bonus_Location.PRODUCT_BONUS_MST_ID = Convert.ToInt32(dataTable_location.Rows[i]["PRODUCT_BONUS_MST_ID"]);
                ...
                _bonus_Mst.Bonus_Dtls = new List<Product_Bonus_Dtl>();

                for (int i = 0; i < dataTable_dlts.Rows.Count; i++)
                {
                    Product_Bonus_Dtl _bonus_Dtl = new Product_Bonus_Dtl();

                    _bonus_Dtl.PRODUCT_BONUS_DTL_ID = Convert.ToInt32(dataTable_dlts.Rows[i]["PRODUCT_BONUS_DTL_ID"]);
                    _bonus_Dtl.PRODUCT_BONUS_MST_ID = Convert.ToInt32(dataTable_dlts.Rows[i]["PRODUCT_BONUS_MST_ID"]);
                    _bonus_Dtl.PRODUCT_BONUS_QTY = Convert.ToDecimal(dataTable_dlts.Rows[i]["PRODUCT_BONUS_QTY"]);
                    _bonus_Dtl.PRODUCT_BONUS_SKU_CODE = dataTable_dlts.Rows[i]["PRODUCT_BONUS_SKU_CODE"].ToString();
                    _bonus_Dtl.PRODUCT_BONUS_SKU_ID = Convert.ToInt32(dataTable_dlts.Rows[i]["PRODUCT_BONUS_SKU_ID"]);
                    _bonus_Dtl.PRODUCT_BONUS_SLAB_TYPE = dataTable_dlts.Rows[i]["PRODUCT_BONUS_SLAB_TYPE"].ToString();
                    _bonus_Dtl.PRODUCT_BONUS_TYPE = dataTable_dlts.Rows[i]["PRODUCT_BONUS_TYPE"].ToString();
        ...
        public async Task<string> AddOrUpdate(string db, int Company_Id, Product_Bonus_Mst model)
        {
            if (model == null)
            {
            ...
            else
            {
                ...
                try
                {
                    ...
                    if (model.PRODUCT_BONUS_MST_ID == 0)
                    {

                        model.PRODUCT_BONUS_MST_ID = _commonServices.GetMaximumNumber<int>(_configuration.GetConnectionString(db), GetNewBonus_Mst_IdQuery(), _commonServices.AddParameter(new string[] { }));

                        listOfQuery.Add(_commonServices.AddQuery(AddOrUpdate_AddBonus_MstQuery(), _commonServices.AddParameter(new string[] { model.PRODUCT_BONUS_MST_ID.ToString(), model.BONUS_NAME, model.COMPANY_ID.ToString(), model.EFFECT_END_DATE, model.EFFECT_START_DATE, model.ENTERED_BY, model.ENTERED_DATE, model.ENTERED_TERMINAL, model.ENTRY_DATE, model.LOCATION_TYPE, model.REMARKS,model.STATUS,model.UNIT_ID.ToString(),model.SKU_ID.ToString(),model.SKU_CODE })));
                        ...
                        {
                            item.PRODUCT_BONUS_LOCATION_ID = location_id;
                            listOfQuery.Add(_commonServices.AddQuery(AddOrUpdate_AddBonus_LocationQuery(), _commonServices.AddParameter(new string[] { item.PRODUCT_BONUS_LOCATION_ID.ToString(), model.PRODUCT_BONUS_MST_ID.ToString(), model.ENTERED_BY, model.ENTERED_DATE, model.ENTERED_TERMINAL, item.LOCATION_CODE, item.LOCATION_ID.ToString(), model.LOCATION_TYPE, item.STATUS })));
                            location_id++;
                        }
                        ...
                        {
                            item.PRODUCT_BONUS_DTL_ID = detail_id;

                            listOfQuery.Add(_commonServices.AddQuery(AddOrUpdate_AddBonus_DltQuery(), _commonServices.AddParameter(new string[] { item.PRODUCT_BONUS_DTL_ID.ToString(), model.PRODUCT_BONUS_MST_ID.ToString(),item.PRODUCT_BONUS_QTY.ToString(),item.PRODUCT_BONUS_SKU_CODE,item.PRODUCT_BONUS_SKU_ID.ToString(),item.PRODUCT_BONUS_SLAB_TYPE,item.PRODUCT_BONUS_TYPE,item.CALCULATION_TYPE,item.DISCOUNT_PCT.ToString(),item.DISCOUNT_VAL.ToString(), model.ENTERED_BY, model.ENTERED_DATE, model.ENTERED_TERMINAL, item.GIFT_ITEM_ID.ToString(),item.GIFT_QTY.ToString(),item.SLAB_QTY.ToString(),item.STATUS })));
                            detail_id++;
                        }
                    ...
                    else
                    {
                        ...
                        listOfQuery.Add(_commonServices.AddQuery(AddOrUpdate_UpdateBonusMst_Query(), _commonServices.AddParameter(new string[] { model.PRODUCT_BONUS_MST_ID.ToString(), model.BONUS_NAME, model.EFFECT_END_DATE, model.EFFECT_START_DATE, model.LOCATION_TYPE, model.REMARKS, model.STATUS, model.UPDATED_BY, model.UPDATED_DATE, model.UPDATED_TERMINAL,model.SKU_ID.ToString(),model.SKU_CODE })));
                        int location_id = _commonServices.GetMaximumNumber<int>(_configuration.GetConnectionString(db), GetNewBonus_location_IdQuery(), _commonServices.AddParameter(new string[] { }));

                        for (int i = 0; i < model.Bonus_Locations.Count; i++)
                        {
                            if(model.Bonus_Locations[i].PRODUCT_BONUS_LOCATION_ID==0)
                            {

                                    model.Bonus_Locations[i].PRODUCT_BONUS_LOCATION_ID = location_id;
                                    listOfQuery.Add(_commonServices.AddQuery(AddOrUpdate_AddBonus_LocationQuery(), _commonServices.AddParameter(new string[] { model.Bonus_Locations[i].PRODUCT_BONUS_LOCATION_ID.ToString(), model.PRODUCT_BONUS_MST_ID.ToString(), model.ENTERED_BY, model.ENTERED_DATE, model.ENTERED_TERMINAL, model.Bonus_Locations[i].LOCATION_CODE, model.Bonus_Locations[i].LOCATION_ID.ToString(), model.LOCATION_TYPE, model.Bonus_Locations[i].STATUS })));
                                    location_id++;
                        ...
                        {
                            if (model.Bonus_Dtls[i].PRODUCT_BONUS_DTL_ID == 0)
                            {

                                model.Bonus_Dtls[i].PRODUCT_BONUS_DTL_ID = detail_id;

                                listOfQuery.Add(_commonServices.AddQuery(AddOrUpdate_AddBonus_DltQuery(), _commonServices.AddParameter(new string[] { model.Bonus_Dtls[i].PRODUCT_BONUS_DTL_ID.ToString(), model.PRODUCT_BONUS_MST_ID.ToString(), model.Bonus_Dtls[i].PRODUCT_BONUS_QTY.ToString(), model.Bonus_Dtls[i].PRODUCT_BONUS_SKU_CODE, model.Bonus_Dtls[i].PRODUCT_BONUS_SKU_ID.ToString(), model.Bonus_Dtls[i].PRODUCT_BONUS_SLAB_TYPE, model.Bonus_Dtls[i].PRODUCT_BONUS_TYPE, model.Bonus_Dtls[i].CALCULATION_TYPE, model.Bonus_Dtls[i].DISCOUNT_PCT.ToString(), model.Bonus_Dtls[i].DISCOUNT_VAL.ToString(), model.ENTERED_BY, model.ENTERED_DATE, model.ENTERED_TERMINAL, model.Bonus_Dtls[i].GIFT_ITEM_ID.ToString(), model.Bonus_Dtls[i].GIFT_QTY.ToString(), model.Bonus_Dtls[i].SLAB_QTY.ToString(), model.Bonus_Dtls[i].STATUS })));
                                detail_id++;
