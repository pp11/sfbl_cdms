ngApp.controller('ngGridCtrl', ['$scope', 'ReceiveFromOthersServices', 'permissionProvider', 'notificationservice', 'gridregistrationservice', '$http', '$log', '$filter', '$timeout', '$interval', '$q', function ($scope, ReceiveFromOthersServices, permissionProvider, notificationservice, gridregistrationservice, $http, $log, $filter, $timeout, $interval, $q) {
    ...
    $scope.gridOptionsList.columnDefs = [
        ...
        //}
        , {
            name: 'SUPPLIER_NAME', field: 'SUPPLIER_NAME', displayName: 'Supplier', enableFiltering: true, width: '15%'
        }, {
        ...
        , {
            name: 'SKU_NAME', field: 'SKU_NAME', displayName: 'SKU Name', enableFiltering: true, width: '27%'
        }
        , {
    ...
    $scope.EditData = function (entity) {
        ...
        window.location = "/Inventory/FGReceiveFromOthers/ReceiveFromOthers?Id=" + entity.RECEIVE_ID_ENCRYPTED;
    }
    
    $scope.DataLoad = function (model) {
        $scope.showLoader = true;

        ReceiveFromOthersServices.PendingList(model.COMPANY_ID, model.DATE_FROM, model.DATE_TO).then(function (data) {
            
            $scope.gridOptionsList.data = data.data;
            $scope.showLoader = false;
            $scope.model.COMPANY_SEARCH_ID = model.companyId;
        }, function (error) {
    ...
    $scope.ClearForm = function () {
        window.location = "/Inventory/FGReceiveFromOthers/ReceiveFromOthersList";
    }
    ...
    $scope.GetPermissionData = function () {
        ...
        $scope.permissionReqModel = {
            ...
            Action_Name: 'ReceiveFromOthersList'
        }
