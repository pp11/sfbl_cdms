ngApp.controller('ngGridCtrl', ['$scope', 'CustomerTargetService', 'permissionProvider', 'gridregistrationservice', 'notificationservice', '$http', '$log', '$filter', '$timeout', '$interval', '$q', function ($scope, CustomerTargetService, permissionProvider, gridregistrationservice, notificationservice, $http, $log, $filter, $timeout, $interval, $q) {
    ...
    $scope.SaveData = function (model) {
        ...
        if (model.CUSTOMER_ID == null && model.CUSTOMER_ID == '' & model.CUSTOMER_ID == undefined) {
            notificationservice.Notification("Select Customer!", "", 'Select Customer!');
        }
        else {
            var customer = $scope.Customers.find(e => e.CUSTOMER_ID == $scope.model.CUSTOMER_ID);
            $scope.model.CUSTOMER_CODE = customer.CUSTOMER_CODE;
            $scope.model.UNIT_ID = customer.UNIT_ID;
        }
    ...
    $scope.GetPermissionData = function () {
        ...
        $scope.permissionReqModel = {
            ...
            Action_Name: 'CustomerNationalTarget'
        }
