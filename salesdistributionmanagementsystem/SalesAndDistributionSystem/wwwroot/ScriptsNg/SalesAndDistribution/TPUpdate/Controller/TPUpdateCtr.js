ngApp.controller('ngGridCtrl', ['$scope', 'batchPriceServices', 'LiveNotificationServices', 'permissionProvider', 'notificationservice', 'gridregistrationservice', '$http', '$log', '$filter', '$timeout', '$interval', '$q', function ($scope, batchPriceServices, LiveNotificationServices, permissionProvider, notificationservice, gridregistrationservice, $http, $log, $filter, $timeout, $interval, $q) {
    ...
    $scope.loadBatchWiseStock = function (model) {
        ...
        if (model.BATCH_NO == undefined || model.BATCH_NO == 0 || model.BATCH_NO == null || model.BATCH_NO == '') {
    ...
    $scope.gridOptions = (gridregistrationservice.GridRegistration("TP Update"));
    ...
    $scope.gridOptions.columnDefs = [
        ...
        { name: 'BATCH_NO', field: 'BATCH_NO', enableColumnMenus: false, displayName: 'Batch No', enableFiltering: false, width: '20%', cellTemplate: '<input type="text" disabled style="text-align: left;" ng-model="row.entity.BATCH_NO" class="pl-sm" />' },
        { name: 'BATCH_ID', field: 'BATCH_ID', enableColumnMenus: false, displayName: 'Batch Id', enableFiltering: false, width: '20%', visible: false, cellTemplate: '<input type="text" disabled style="text-align: left;" ng-model="row.entity.BATCH_ID" class="pl-sm" />' },
        { name: 'UNIT_TP', field: 'UNIT_TP', enableColumnMenus: false, displayName: 'Unit TP', enableFiltering: false, width: '20%', cellTemplate: '<input type="number" style="text-align: right;" ng-model="row.entity.UNIT_TP" class="pl-sm" />' },
        { name: 'MRP', field: 'MRP', enableColumnMenus: false, displayName: 'MRP', enableFiltering: false, width: '20%', cellTemplate: '<input type="number" style="text-align: right;" ng-model="row.entity.MRP" class="pl-sm" />' },
        { name: 'SKU_CODE', field: 'SKU_CODE', enableColumnMenus: false, displayName: 'SKU Code', enableFiltering: false, width: '20%', visible: false, cellTemplate: '<input type="text" style="text-align: left;" ng-model="row.entity.SKU_CODE" class="pl-sm" />' },
        { name: 'SKU_ID', field: 'SKU_ID', enableColumnMenus: false, displayName: 'SKU Id', enableFiltering: false, width: '20%', visible: false, cellTemplate: '<input type="text" disabled style="text-align: left;" ng-model="row.entity.SKU_ID" class="pl-sm" />' }
    ];
    ...
    $scope.ClearForm = function () {
        window.location.href = "/SalesAndDistribution/ProductPrice/TPUpdate";
    }
