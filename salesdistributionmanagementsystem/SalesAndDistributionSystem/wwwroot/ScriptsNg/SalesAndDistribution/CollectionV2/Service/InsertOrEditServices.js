ngApp.service("InsertOrEditServices", function ($http) {
    ...
    this.LoadData = function (companyId) {
        return $http.post('/SalesAndDistribution/CollectionV2/LoadData');
    }
    ...
    this.LoadBranchData = function () {
        return $http.post('/SalesAndDistribution/CollectionV2/LoadBranchData');
    }
    this.LoadCollectionModeData = function () {
        return $http.post('/SalesAndDistribution/CollectionV2/LoadCollectionMode');
    }
    ...
    this.LoadCustomerDaywiseBalance = function (cust_id) {
        ...
        return $http.post('/SalesAndDistribution/CollectionV2/LoadCustomerDaywiseBalance', { CUSTOMER_ID: cust_id });
    }
    ...
    this.GetEditDataById = function (id, UNIT_ID) {
        ...
        return $http.post('/SalesAndDistribution/CollectionV2/GetEditDataById', { q: id, UNIT_ID: UNIT_ID });
    }
    ...
    this.AddOrUpdate = function (model) {
        ...
        return $http({
            type: 'POST',
            method: 'POST',
            url: "/SalesAndDistribution/CollectionV2/AddOrUpdate",
            dataType: 'json',
    ...
    this.Update_Approval = function (collection_mst_id) {
        return $http.post('/SalesAndDistribution/CollectionV2/Update_Approval', { COLLECTION_MST_ID: parseInt(collection_mst_id) });
    }
});